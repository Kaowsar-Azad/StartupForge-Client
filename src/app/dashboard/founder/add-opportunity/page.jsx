    ...
    <PrivateRoute allowedRoles={["founder"]}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {!startup ? (
          ...
          <>
            {!isPremium && (
              <div className="bg-gradient-to-r from-blue-900/40 to-slate-900 border border-blue-500/20 p-6 rounded-2xl flex flex-col lg:flex-row justify-between items-center gap-4 text-white mb-8">
                <div>
                  ...
                  <p className="text-xs text-slate-300 mt-1 max-w-xl">
                    {oppsCount >= 3 
                      ? "You have used your 3 free opportunity listings. Upgrade to post unlimited opportunities." 
